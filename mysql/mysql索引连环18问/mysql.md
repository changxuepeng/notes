...
https://mp.weixin.qq.com/s/dgODsEr5uuapj80-BzQyuw

> 本文已同步Github仓库，欢迎小伙伴star，点击文末左侧的**阅读原文**即可直达仓库，Github地址：https://github.com/cosen1024/Java-Interview
>
> 
...
![图片](mysql.assets/640-16306308089692)

**B-Tree索引**（MySQL使用B+Tree）

B-Tree能加快数据的访问速度，因为存储引擎不再需要进行全表扫描来获取数据，数据分布在各个节点之中。

![图片](mysql.assets/640-16306308372194)
...
![图片](mysql.assets/640-16306308456226)
...
![img](mysql.assets/70-16306319429729)
...
![图片](mysql.assets/640-163063212644513)

插入非连续的数据：

![图片](mysql.assets/640-163063212499611)
